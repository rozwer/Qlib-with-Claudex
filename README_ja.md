...
本プロジェクトは [Microsoft Qlib](https://github.com/microsoft/qlib)（AI 駆動の量的投資プラットフォーム）の上に構築されています。

Qlib はデータ処理・モデル学習・バックテストまでの ML パイプラインを提供し、アルファ探索から注文執行まで量的投資の全工程をカバーします。

### 主要機能（upstream Qlib）

- **[モデル Zoo](Qlib-with-Claudex/examples/benchmarks/)** — 20+ の SOTA モデル（LightGBM, LSTM, Transformer, TRA, HIST 等）
- **[データセット Zoo](Qlib-with-Claudex/qlib/contrib/data/handler.py)** — Alpha158, Alpha360（米国・中国市場）
- **[自動ワークフロー](https://qlib.readthedocs.io/en/latest/component/workflow.html)** — `qrun` でエンドツーエンドのリサーチ
- **[強化学習](https://qlib.readthedocs.io/en/latest/component/rl.html)** — 注文執行の最適化
- **[オンライン配信](https://qlib.readthedocs.io/en/latest/component/online.html)** — 自動ローリングでモデルをデプロイ

### Qlib ドキュメント

- [公式ドキュメント](https://qlib.readthedocs.io/)
- [チュートリアル（Notebook）](Qlib-with-Claudex/examples/tutorial/)
- [元の README](Qlib-with-Claudex/README.md)

### RD-Agent について

[Microsoft RD-Agent](https://github.com/microsoft/RD-Agent) は LLM 駆動の自律型 R&D エージェントフレームワークです。本プロジェクトでは OpenAI バックエンドを Claude Code サブエージェントに置き換えています。

- [RD-Agent 論文](https://arxiv.org/abs/2505.15155)
- [元の README](RD-Agent-with-Claudex/README.md)
